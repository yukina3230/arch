...
# Set Aliases
alias --save lock="xdg-screensaver lock"
alias --save suspend="systemctl suspend"
alias --save update-grub="grub-mkconfig -o /boot/grub/grub.cfg"
alias --save update-init="mkinitcpio -p linux"
